/*
This Webpack-config builds a version of VsmDictionaryPubMed that can be
...
module.exports = () => ({
  ...
  output: {
    path: dist,
    filename: 'vsm-dictionary-pubmed.min.js',
    library: 'VsmDictionaryPubMed',
    libraryTarget: 'var'
  }
});
